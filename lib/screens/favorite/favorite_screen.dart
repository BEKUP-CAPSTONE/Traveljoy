              ...
              child: favProvider.favorites.isEmpty
                ...
                itemBuilder: (context, index) {
                  ...
                  if (alamatLengkap.isNotEmpty) {
                    ...
                    displayAddress = "${lokasi.isNotEmpty ? lokasi : ''}${lokasi.isNotEmpty && namaDaerah.isNotEmpty ? ', ' : ''}${namaDaerah.isNotEmpty ? namaDaerah : ''}";
                  } else {
                    displayAddress = '';
                  }
                    ...
                    onTap: () {
                      if (wisataId > 0) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(content: Text('ID wisata tidak valid untuk navigasi.')),
                        );
                      }
                    },
                    child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      if (hasLocation)
                                        Row(
                                          children: [
                                            Icon(Icons.location_on, color: kTeal, size: 16),
