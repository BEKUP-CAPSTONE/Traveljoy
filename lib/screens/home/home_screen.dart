...
class _HomeScreenState extends State<HomeScreen> {
  final TextEditingController _searchController = TextEditingController();
  bool _isBackgroundFading = false;
  ...
  String _buildDisplayAddress(Map<String, dynamic> wisata) {
    ...
    if (alamatLengkap.isNotEmpty) {
      ...
      final parts = [
        ...
        if (namaDaerah.isNotEmpty) namaDaerah,
      ];
      return parts.join(', ');
    }
    ...
    return SizedBox(
      ...
      child: PageView.builder(
        ...
        onPageChanged: (index) {
          setState(() {
            final realIndex = index % _bannerImages.length;
            final bool isActive = _currentBannerPage == realIndex;
          });
        },
        itemBuilder: (context, index) {
          final bool isActive = _currentBannerPage == index;
